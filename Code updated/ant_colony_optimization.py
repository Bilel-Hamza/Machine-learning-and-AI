...
EVAPORATION_FACTOR = 0.6 # number between 0 and 1; 0 for complete evaporation, 1 for no evaporation
...
def execute(points, number_of_cities):
    ...
    # Prepare city names (you should have a list of names defined)
    city_names = [f"City {i}" for i in range(number_of_cities)]  # Example list of city names
    ...
    # Add black points at each city location
